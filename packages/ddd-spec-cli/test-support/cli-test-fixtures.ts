...
export const CLI_DIST_VIEWER_GENERATED_EN_SPEC_PATH = toAbsolutePath(
  "../dist/ddd-spec-cli/static/viewer/generated/viewer-spec.en.json"
);
export const CLI_DIST_VIEWER_GENERATED_ZH_CN_SPEC_PATH = toAbsolutePath(
