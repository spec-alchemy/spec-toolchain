...
- [`ddd-spec.config.yaml`](./ddd-spec.config.yaml) is the tracked repo-local vNext example path; if the default maintainer demo changes, update this config, the root docs, and config tests together.
