import { cardObject, connectionObject, objectIds } from "./canonical/index.js";
import { businessSpec } from "./generated/business-spec.generated.js";
...
/**
 * Converts generated command/event metadata into a plain message shape.
 *
 * The current canonical field vocabulary is string-based, so generated payload
 * fields are projected to `string` here. If canonical scalar types expand,
 * this helper is the single place to extend the mapping.
 */
